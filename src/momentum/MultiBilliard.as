package momentum {
	...
	public class MultiBilliard extends Sprite {
		...
		private function init():void {
			balls = new Array();
			/**
			 * NOTE: spaced out the initial x and y positions of each ball to ensure that they were
			 * not touching each other to start with. If so, they could get stuck together
			**/
		...
		private function checkCollision(ball0:Ball, ball1:Ball):void {
			...
			if(dist <  ball0.radius + ball1.radius) {
				...
				// rotate ball0's position, since ball0 is "pivot point", so the point is (0,0)
				...
				//update position
				//NOTE: ======= FIX STUCK TOGETHER PROBLEM, ensure the sprites are definitely separated before moving on=======
		...
		private function rotate(x:Number, y:Number, sin:Number, cos:Number, reverse:Boolean = false):Point {
